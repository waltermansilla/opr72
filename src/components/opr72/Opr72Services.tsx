...
function DeptModal({
    ...
    const adjacent = deptId
        ? getAdjacentDepts(deptId)
        : { prev: null, next: null };
    ...
    useEffect(() => {
        ...
        updateCloseContrast();
        scrollEl.addEventListener("scroll", updateCloseContrast, {
            passive: true,
        });
                    ...
                    >
                        ...
                        <div className="shrink-0 border-t border-[var(--opr-navy)]/8 bg-white px-3 py-2.5 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:hidden">
                            <div className="flex items-stretch gap-1 rounded-xl bg-[var(--opr-foam)] p-1">
                                ...
                                />
                                <div
                                    className="my-1.5 w-px shrink-0 bg-[var(--opr-navy)]/10"
                                    aria-hidden
                                />
                                <DeptModalMobileNavButton
...
export default function Opr72Services() {
    ...
    return (
        <section
            id={services.id}
            className="bg-[var(--opr-foam)] pt-24 sm:pt-28 lg:pt-32"
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-3 pb-8 lg:hidden">
                    {services.departments.map((dept) => (
                        <DeptAccordionItem
                            ...
                            onToggle={() =>
                                setExpandedDeptId((current) =>
                                    current === dept.id ? null : dept.id,
                                )
                            }
                ...
                <div className="hidden lg:grid lg:grid-cols-3 lg:gap-6 lg:pb-8">
                    {services.departments.map((dept) => (
                        <DeptCard
                            key={dept.id}
                            dept={dept}
                ...
                {services.closing && (
                    <div className="mx-auto max-w-3xl pb-16 lg:pb-16">
                        <p className="rounded-2xl border border-[var(--opr-sky)]/20 bg-[var(--opr-sky)]/8 px-5 py-5 text-center text-sm font-medium leading-relaxed text-[var(--opr-navy)] sm:px-6 sm:text-base">
                            {services.closing}
                        </p>
                    </div>
                )}
